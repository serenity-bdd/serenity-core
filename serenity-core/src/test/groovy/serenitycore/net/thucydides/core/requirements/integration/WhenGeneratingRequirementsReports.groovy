package serenitycore.net.thucydides.core.requirements.integration
...
import serenitymodel.net.thucydides.core.reports.history.DateProvider
...
class WhenGeneratingRequirementsReports extends Specification {
    ...
    serenitycore.net.thucydides.core.requirements.reportpages.RequirementsReport report
