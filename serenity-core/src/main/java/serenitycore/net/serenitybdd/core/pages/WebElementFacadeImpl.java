...
import serenitycore.net.thucydides.core.annotations.locators.MethodTiming;
import serenitycore.net.thucydides.core.annotations.locators.WithConfigurableTimeout;
...
import serenitycore.net.thucydides.core.webdriver.exceptions.ElementNotFoundAfterTimeoutError;
import serenitycore.net.thucydides.core.webdriver.exceptions.ElementShouldBeDisabledException;
import serenitycore.net.thucydides.core.webdriver.exceptions.ElementShouldBeEnabledException;
import serenitycore.net.thucydides.core.webdriver.exceptions.ElementShouldBeInvisibleException;
import serenitycore.net.thucydides.core.webdriver.exceptions.ElementShouldBePresentException;
import serenitycore.net.thucydides.core.webdriver.exceptions.ElementShouldBeVisibleException;
import serenitycore.net.thucydides.core.webdriver.javascript.JavascriptExecutorFacade;
import serenitycore.net.thucydides.core.webdriver.stubs.WebElementFacadeStub;
...
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.LEGACY_WAIT_FOR_TEXT;
...
public class WebElementFacadeImpl implements WebElementFacade,
    serenitycore.net.thucydides.core.pages.WebElementFacade {
    ...
    public <T extends WebElementFacade> T findBy(String xpathOrCssSelector) {
        ...
        if (driverIsDisabled()) {
            nestedElement = this;
        } else if (Selectors.isXPath(xpathOrCssSelector)) {
    ...
    public <T extends WebElementFacade> T findBy(String xpathOrCssSelector, Object... arguments) {
        return findBy(ParameterisedLocator.withArguments(xpathOrCssSelector, arguments));
    }
    ...
    public ListOfWebElementFacades thenFindAll(String xpathOrCssSelector, Object... arguments) {
        return thenFindAll(ParameterisedLocator.withArguments(xpathOrCssSelector, arguments));
    }
