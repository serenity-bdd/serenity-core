package serenitycore.net.serenitybdd.core.pages.integration

import serenitycore.net.serenitybdd.core.pages.WebElementFacade
import serenitymodel.net.serenitybdd.core.time.Stopwatch
import serenitycore.net.serenitybdd.core.webdriver.servicepools.ChromeServicePool
import serenitycore.net.serenitybdd.core.webdriver.servicepools.DriverServicePool
import serenitycore.net.thucydides.core.pages.integration.StaticSitePage
