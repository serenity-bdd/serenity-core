package serenitycore.net.serenitybdd.core.photography.integration
...
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.DEFAULT_HEIGHT
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.DEFAULT_WIDTH
