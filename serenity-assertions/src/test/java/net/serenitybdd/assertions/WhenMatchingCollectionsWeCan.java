...
public class WhenMatchingCollectionsWeCan {
    ...
    public void find_subsets_in_a_collection() {
        ...
        assertThat(allColors, CollectionMatchers.containsAll(primaryColors));
    }
    ...
    public void report_missing_subsets_in_a_collection() {
        ...
        assertThat(allColors, not(CollectionMatchers.containsAll(otherColors)));
    }
    ...
    public void check_that_all_elements_match_a_predicate() {
        ...
        assertThat(allColors, CollectionMatchers.allMatch( color -> color.startsWith("color:")));
    }
    ...
    public void check_that_all_elements_match_a_predicate_with_a_description() {
        ...
        assertThat(allColors, CollectionMatchers.allMatch( color -> color.startsWith("color:"), "start with 'color:'"));
    }
    ...
    public void check_that_all_elements_satisfy_a_condition() {
        ...
        assertThat(allColors, CollectionMatchers.allSatisfy( color -> Assertions.assertThat(color).startsWith("color:")));
    }
    ...
    public void check_that_the_collection_satisfy_a_condition() {
        ...
        assertThat(allColors, CollectionMatchers.satisfies( colors -> Assertions.assertThat(colors).hasSize(4)));
    }
    ...
    public void check_that_an_element_does_not_match_a_predicate() {
        ...
        assertThat(allColors, not(CollectionMatchers.allMatch( color -> color.startsWith("color:"))));
    }
    ...
    public void check_that_any_elements_match_a_predicate() {
        ...
        assertThat(allColors, CollectionMatchers.anyMatch( color -> color.endsWith("green")));
    }
    ...
    public void check_that_any_elements_match_a_predicate_in_an_empty_list() {
        ...
        assertThat(allColors, not(CollectionMatchers.anyMatch( color -> color.endsWith("green"))));
    }
    ...
    public void check_that_any_element_match_a_predicate_with_a_description() {
        ...
        assertThat(allColors, CollectionMatchers.anyMatch(color -> color.endsWith("green"), "ends with green"));
    }
