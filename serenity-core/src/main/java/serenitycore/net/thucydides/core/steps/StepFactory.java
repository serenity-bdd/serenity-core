...
import serenitycore.net.serenitybdd.core.exceptions.StepInitialisationException;
...
import serenitycore.net.thucydides.core.steps.construction.ConstructionStrategy;
import serenitycore.net.thucydides.core.steps.construction.StepLibraryConstructionStrategy;
import serenitycore.net.thucydides.core.steps.construction.StepLibraryType;
...
public class StepFactory {
    ...
    private <T> T createProxyStepLibrary(Class<T> scenarioStepsClass,
        ...
        try {
            ...
            } else if (ConstructionStrategy.INNER_CLASS_CONSTRUCTOR.equals(strategy)) {
