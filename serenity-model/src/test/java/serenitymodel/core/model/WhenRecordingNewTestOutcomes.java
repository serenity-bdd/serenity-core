package serenitymodel.core.model;

import serenitymodel.core.matchers.ThucydidesMatchers;
...
import serenitymodel.net.thucydides.core.annotations.Issue;
import serenitymodel.net.thucydides.core.annotations.Issues;
...
import serenitymodel.net.thucydides.core.steps.StepFailureException;
...
public class WhenRecordingNewTestOutcomes {
    ...
    public void should_report_failures_or_errors_outside_of_steps() {
        TestOutcome outcome = TestOutcome.forTest("should_do_this", SomeTestScenario.class);
        outcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("The user opens the Google search page"));
    ...
    public void a_test_outcome_title_should_be_the_method_name_if_no_test_class_is_defined() {
        serenitymodel.net.thucydides.core.model.Story story = serenitymodel.net.thucydides.core.model.Story
            .from(AUserStory.class);
    ...
    public void should_record_simple_test_steps() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("The user opens the Google search page"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("The user searches for Cats"));
    ...
    public void should_record_nested_test_steps() {
        ...
        testOutcome.recordSteps(NewList.of(TestStepFactory.forASuccessfulTestStepCalled("Step 1"),
            TestStepFactory.forASuccessfulTestStepCalled("Step 2")));
        testOutcome.startGroup();
        testOutcome.recordSteps(NewList.of(TestStepFactory.forASuccessfulTestStepCalled("Step 2.1"), TestStepFactory
            .forASuccessfulTestStepCalled("Step 2.2")));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
    ...
    public void should_record_deeply_nested_test_steps() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2.1"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2.1.1"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2.1.1.1"));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2.1.2"));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2.2"));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
    ...
    public void should_list_screenshots_in_steps() {
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_1"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_3"));

        MatcherAssert.assertThat(testOutcome.getScreenshots(), ThucydidesMatchers
            .hasFilenames("step_1.png", "step_2.png", "step_3.png"));
    }
    ...
    public void should_list_screenshots_for_leaf_steps_in_nested_steps() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2.1"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2.1.1"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2.1.1.1"));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2.1.2"));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_2.2"));
        testOutcome.endGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("step_3"));
    ...
    public void the_acceptance_test_case_is_a_failure_if_one_test_has_failed() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 2", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 3"));
    ...
    public void the_acceptance_test_case_is_an_error_if_one_test_has_thrown_a_non_assertion_exception() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 2", new WebDriverException("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 3"));
    ...
    public void the_acceptance_test_case_is_compromised_if_a_compromising_exception_is_raised() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 2", new TestCompromisedException("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 3"));
    ...
    public void the_acceptance_test_case_is_failing_if_multiple_tests_have_failed() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 2", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 3", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
    ...
    public void the_acceptance_test_case_is_failing_if_a_test_step_failed() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory
            .forABrokenTestStepCalled("Step 2", new StepFailureException("Oh bother",new AssertionError("Oh bother!"))));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
    ...
    public void the_acceptance_test_case_is_in_error_if_a_test_step_has_an_error() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 2", new StepFailureException("Oh bshould_not_resize_image_if_target_height_is_larger_than_the_maximum_heightother",new NoSuchElementException("Can't find element"))));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
    ...
    public void the_acceptance_test_case_is_in_error_if_multiple_tests_have_failed_or_are_broken() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 2", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 3", new WebDriverException("Oh deary me!")));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
    ...
    public void the_acceptance_test_case_is_pending_if_at_least_one_test_is_pending_and_none_have_failed() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
    ...
    public void the_acceptance_test_case_is_ignored_if_all_test_cases_are_ignored() {
        ...
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 4"));
    ...
    public void if_one_test_is_ignored_among_others_it_will_not_affect_the_outcome_for_failing_tests() {
        ...
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 3", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 4"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 5"));
    ...
    public void if_one_test_is_ignored_among_others_it_will_not_affect_the_outcome_for_pending_tests() {
        ...
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 4"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 5"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 6"));
    ...
    public void the_model_should_provide_the_number_of_successful_test_steps_in_presence_of_other_outcomes() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 4", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 5"));
    ...
    public void the_model_should_provide_the_number_of_failed_test_steps() {
        ...
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 4", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 5", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 6"));
    ...
    public void the_model_should_provide_the_number_of_ignored_test_steps() {
        ...
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 5", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 6"));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 7"));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 8"));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 9"));
    ...
    public void the_model_should_provide_the_number_of_pending_test_steps() {
        ...
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 5", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 6"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 7"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 8"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 9"));
    ...
    public void an_acceptance_test_run_can_contain_steps_nested_in_step_groups() {
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("A Group"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
    ...
    private void createNestedTestSteps() {
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 0"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("A group"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Another group"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 5"));
        testOutcome.endGroup();
    ...
    private void createNestedTestRun() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 7", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 10"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Another group"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 5"));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 6"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 7", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 8", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 9"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 10"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 11"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 12"));
        testOutcome.endGroup();
        testOutcome.endGroup();
    }
    ...
    public void a_test_group_with_a_failing_test_fails() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forABrokenTestStepCalled("Step 3", new AssertionError("Oh bother!")));
        testOutcome.recordStep(TestStepFactory.forASkippedTestStepCalled("Step 4"));
        testOutcome.recordStep(TestStepFactory.forAnIgnoredTestStepCalled("Step 5"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
        testOutcome.endGroup();
    ...
    public void a_test_group_with_a_pending_test_is_pending() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forAPendingTestStepCalled("Step 3"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 4"));
        testOutcome.endGroup();
    ...
    public void should_be_able_to_find_the_last_step_in_a_group() {
        ...
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Group 1"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Group 2"));
        testOutcome.startGroup();
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 1"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 2"));
        testOutcome.recordStep(TestStepFactory.forASuccessfulTestStepCalled("Step 3"));
