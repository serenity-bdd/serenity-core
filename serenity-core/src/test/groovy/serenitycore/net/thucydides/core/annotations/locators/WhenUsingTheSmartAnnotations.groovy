...
import serenitycore.net.thucydides.core.annotations.locators.SmartAnnotations
...
class WhenUsingTheSmartAnnotations extends Specification {
    ...
    def "should find the correct By class"() {
        ...
        AnnotatedPageSample.class.getField("byJQuery")          | serenitycore.net.serenitybdd.core.annotations.findby.By.ByjQuerySelector
        AnnotatedPageSample.class.getField("bySCLocator")       | serenitycore.net.serenitybdd.core.annotations.findby.By.ByScLocator
    ...
    def "should find the correct By class using long ID"() {
        ...
        AnnotatedPageSample.class.getField("byJQueryLong")      | serenitycore.net.serenitybdd.core.annotations.findby.By.ByjQuerySelector
        AnnotatedPageSample.class.getField("bySCLocatorLong")   | serenitycore.net.serenitybdd.core.annotations.findby.By.ByScLocator
    }
