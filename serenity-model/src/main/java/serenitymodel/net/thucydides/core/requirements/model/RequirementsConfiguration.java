package serenitymodel.net.thucydides.core.requirements.model;
...
import serenitymodel.net.thucydides.core.requirements.SearchForFilesOfType;
...
public class RequirementsConfiguration {
    public final static List<String> DEFAULT_CAPABILITY_TYPES = NewList
        .of("capability", "feature", "story");
