package serenitymodel.core.reports.integration;
...
import serenitymodel.net.thucydides.core.reports.xml.XMLTestOutcomeReporter;
...
import static serenitymodel.core.reports.integration.TestStepFactory.successfulTestStepCalled;
...
public class WhenGeneratingAnXMLReport {
    ...
    public void should_get_tags_from_user_story_if_present() {
        ...
        assertThat(testOutcome.getTags(), hasItem(
            TestTag.withName("When generating an XML report/A user story").andType("story")));
    }
