...
public class InputField {
    ...
    private static final String BY_ID_OR_NAME = "css:input[id='{0}' i],input[name='{0}' i],input[class*='{0}' i],input[data-test='{0}' i],textarea[id='{0}' i],textarea[name='{0}' i],textarea[data-test='{0}' i],[placeholder='{0}' i],[aria-label='{0}' i]";
