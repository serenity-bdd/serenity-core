...
"aborted": ${results.countByResult.ABORTED},
...
"aborted": ${results.percentageByResult.ABORTED},
...
<#list coverage as tagCoverageByType>
  ...
  <#list tagCoverageByType.tagCoverage as tagCoverage>
    ...
    "aborted": ${tagCoverage.countByResult.ABORTED},
    ...
    "aborted": ${tagCoverage.percentageByResult.ABORTED},
