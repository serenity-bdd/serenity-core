@cucumber
@version:Release-2
Feature: Adding more new items to the todo list

  In order to avoid having to remember things that need doing
  As a forgetful person
  I want to be able to record what I need to do in a place where I won't forget about them

  Scenario: Adding another item to an empty list
  ...
  Scenario: Adding another item to a list with other items
  ...
  Scenario: Adding more items to several peoples lists
