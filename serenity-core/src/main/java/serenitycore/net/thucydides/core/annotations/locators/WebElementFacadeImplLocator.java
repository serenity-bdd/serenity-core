...
import serenitycore.net.thucydides.core.annotations.NotImplementedException;
...
public class WebElementFacadeImplLocator {
    ...
    public Class<?> getImplementer(Class<?> interfaceType) {
    	...
    	if (implBy == null){
            ...
            serenitycore.net.thucydides.core.annotations.ImplementedBy implByDep = interfaceType.getAnnotation(
                serenitycore.net.thucydides.core.annotations.ImplementedBy.class);
			if(implByDep == null) {
				throw new NotImplementedException(interfaceType.getSimpleName() +
