...
class WhenGeneratingAJsonSummaryReport {
    ...
    inner class AllReports {
        ...
        init {
            generatedReport = JsonSummaryReporter(environmentVariables).generateReportFrom(TEST_OUTCOMES_WITH_MULTIPLE_RESULTS)
        ...
        fun `should be written to serenity-summary_html`() {
            ...
            assertThat(generatedReport.name).isEqualTo("serenity-summary.json")
        }
