...
import serenitymodel.net.thucydides.core.requirements.SerenityTestCaseFinder;
...
public final class TestCaseAnnotations {
    ...
    public void injectDrivers(final WebDriver defaultDriver, final WebdriverManager webdriverManager) {
        List<ManagedWebDriverAnnotatedField> webDriverFields = ManagedWebDriverAnnotatedField
            .findAnnotatedFields(testCase.getClass());
        int driverCount = 1;
    ...
    public static boolean isUniqueSession(Class<?> testClass) {
        ManagedWebDriverAnnotatedField webDriverField = ManagedWebDriverAnnotatedField
            .findFirstAnnotatedField(testClass);
