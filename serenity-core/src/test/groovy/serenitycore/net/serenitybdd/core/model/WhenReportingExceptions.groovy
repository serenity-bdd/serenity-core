package serenitycore.net.serenitybdd.core.model
...
class WhenReportingExceptions extends Specification {
    ...
    def "non-assertion exceptions should be reported as Errors by default"() {
        when:
            def failureAnalysisOf = new FailureAnalysis()
            def result = failureAnalysisOf.resultFor(new serenitycore.net.serenitybdd.core.model.sampleexceptions.MyFailureException())
        then:
