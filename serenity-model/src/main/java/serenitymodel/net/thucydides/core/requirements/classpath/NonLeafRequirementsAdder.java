package serenitymodel.net.thucydides.core.requirements.classpath;
...
import static serenitymodel.net.thucydides.core.requirements.classpath.PathElements.allButLast;
import static serenitymodel.net.thucydides.core.requirements.classpath.PathElements.elementsOf;
...
public class NonLeafRequirementsAdder {
    ...
    public void to(Collection<Requirement> allRequirements) {
        ...
        ChildElementAdder.addChild(leafRequirement).toParent(parent).in(allRequirements);
    }
