...
import serenitymodel.net.thucydides.core.images.ResizableImage;
...
import serenitymodel.net.thucydides.core.model.stacktrace.RootCauseAnalyzer;
...
public class TestStep implements Cloneable {
    ...
    public final static Predicate<TestStep> IGNORED_TESTSTEPS = testStep -> testStep.getResult() == TestResult.IGNORED;
    public final static Predicate<TestStep> COMPROMISED_TESTSTEPS = testStep -> testStep.getResult() == TestResult.COMPROMISED;
    public final static Predicate<TestStep> SUCCESSFUL_TESTSTEPS = testStep -> testStep.getResult() == TestResult.SUCCESS;
    public final static Predicate<TestStep> FAILING_TESTSTEPS = testStep -> testStep.getResult() == TestResult.FAILURE;
    public final static Predicate<TestStep> ERROR_TESTSTEPS = testStep -> testStep.getResult() == TestResult.ERROR;
    public final static Predicate<TestStep> SKIPPED_TESTSTEPS = testStep -> testStep.getResult() == TestResult.SKIPPED;
    ...
    private boolean groupResultOverridesChildren() {
        return ((result == TestResult.SKIPPED) || (result == TestResult.IGNORED) || (result == TestResult.PENDING));
    }
    ...
    public Boolean isIgnored() {
        return getResult() == TestResult.IGNORED;
    }

    public Boolean isSkipped() {
        return getResult() == TestResult.SKIPPED;
    }

    public Boolean isPending() {
        return getResult() == TestResult.PENDING;
    }
