...
import serenitymodel.net.serenitybdd.core.PendingStepException;
import serenitycore.net.serenitybdd.core.annotations.events.AfterExample;
import serenitycore.net.serenitybdd.core.annotations.events.AfterScenario;
import serenitycore.net.serenitybdd.core.annotations.events.BeforeExample;
import serenitycore.net.serenitybdd.core.annotations.events.BeforeScenario;
import serenitycore.net.serenitybdd.core.di.WebDriverInjectors;
import serenitymodel.net.serenitybdd.core.exceptions.TheErrorType;
import serenitycore.net.serenitybdd.core.lifecycle.LifecycleRegister;
import serenitycore.net.serenitybdd.core.photography.Darkroom;
import serenitycore.net.serenitybdd.core.photography.Photographer;
import serenitycore.net.serenitybdd.core.photography.ScreenshotPhoto;
import serenitycore.net.serenitybdd.core.photography.SoundEngineer;
import serenitycore.net.serenitybdd.core.photography.bluring.AnnotatedBluring;
...
import serenitycore.net.serenitybdd.core.webdriver.enhancers.AtTheEndOfAWebDriverTest;
...
import serenitycore.net.thucydides.core.junit.SerenityJUnitTestCase;
...
import serenitymodel.net.thucydides.core.model.failures.FailureAnalysis;
import serenitycore.net.thucydides.core.model.screenshots.ScreenshotPermission;
...
import serenitymodel.net.thucydides.core.screenshots.ScreenshotException;
import serenitymodel.net.thucydides.core.steps.AnnotatedStepDescription;
...
import static serenitymodel.net.thucydides.core.model.Stories.findStoryFrom;
import static serenitymodel.net.thucydides.core.model.TestResult.*;
import static serenitycore.net.thucydides.core.steps.BaseStepListener.ScreenshotType.MANDATORY_SCREENSHOT;
import static serenitycore.net.thucydides.core.steps.BaseStepListener.ScreenshotType.OPTIONAL_SCREENSHOT;
...
//                            .withResult(TestResult.IGNORED));
    ...
    public void testSuiteFinished() {
        ...
        if (this.currentTestIsABrowserTest()) {
            this.closeBrowsers.forTestSuite(this.testSuite).closeIfConfiguredForANew(
                RestartBrowserForEach.FEATURE);
        }
    ...
    public void testFinished(final TestOutcome outcome, boolean inDataDrivenTest) {
        ...
        if (currentTestIsABrowserTest()) {
            ...
            if (inDataDrivenTest) {
                closeBrowsers.forTestSuite(testSuite).closeIfConfiguredForANew(
                    RestartBrowserForEach.EXAMPLE);
            } else {
                closeBrowsers.forTestSuite(testSuite).closeIfConfiguredForANew(
                    RestartBrowserForEach.SCENARIO);
                ThucydidesWebDriverSupport.clearDefaultDriver();
            }
...
//                || (!ThucydidesWebDriverSupport.getDriversUsed().isEmpty());
    ...
    public void exampleFinished() {
        ...
        closeBrowsers.forTestSuite(testSuite).closeIfConfiguredForANew(RestartBrowserForEach.EXAMPLE);
    }
