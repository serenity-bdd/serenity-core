...
import serenitycore.net.thucydides.core.scheduling.NormalFluentWait;
...
import static serenitycore.net.serenitybdd.core.pages.FindAllWaitOptions.WITH_NO_WAIT;
import static serenitycore.net.serenitybdd.core.pages.FindAllWaitOptions.WITH_WAIT;
...
public class RenderedPageObjectView {
    ...
    public void waitFor(String xpathOrCssSelector) {
        waitFor(Selectors.xpathOrCssSelector(xpathOrCssSelector));
    }
    ...
    public void waitForAbsenceOf(String xpathOrCssSelector) {
        waitForElementsToDisappear(Selectors.xpathOrCssSelector(xpathOrCssSelector));
    }
...
//    }
    ...
    public List<WebElementFacade> findAll(String xpathOrCssSelector) {
        return findAll(Selectors.xpathOrCssSelector(xpathOrCssSelector));
    }
    ...
    public WebElementFacade find(String xpathOrCssSelector) {
        return find(Selectors.xpathOrCssSelector(xpathOrCssSelector));
    }
