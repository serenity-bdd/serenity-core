package serenitymodel.net.thucydides.core.model.screenshots

import serenitymodel.net.thucydides.core.model.TakeScreenshots
import serenitymodel.net.thucydides.core.model.screenshots.ScreenshotPreferencesByClass
...
class WhenConfiguringScreenshotsByClassType extends Specification {
    ...
    def "should override the screenshot configuration based on the type of a class"() {
        given:
        environmentVariables.setProperty("serenity.take.screenshots.for.interactions","disabled")
        when:
        ScreenshotPreferencesByClass screenshotPreferencesByClass = ScreenshotPreferencesByClass.forClass(SomeAction)
                .withEnvironmentVariables(environmentVariables)
        then:
