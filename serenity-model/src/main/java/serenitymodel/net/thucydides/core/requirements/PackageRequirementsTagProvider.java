...
import serenitymodel.net.thucydides.core.requirements.annotations.ClassInfoAnnotations;
import serenitymodel.net.thucydides.core.requirements.classpath.LeafRequirementAdder;
import serenitymodel.net.thucydides.core.requirements.classpath.NonLeafRequirementsAdder;
...
public class PackageRequirementsTagProvider extends AbstractRequirementsTagProvider
    ...
    public PackageRequirementsTagProvider(EnvironmentVariables environmentVariables, String rootPackage) {
        this(environmentVariables,
                ...
                (isEmpty(rootPackage) ?
                        ...
                        new FileSystemRequirementsStore(getRequirementsDirectory(
                            ConfiguredEnvironment.getConfiguration().getOutputDirectory()),
    ...
    private boolean classRepresentsARequirementIn(ClassPath.ClassInfo classInfo) {
        return (ClassInfoAnnotations.theClassDefinedIn(classInfo)
                ...
                .hasAPackageAnnotation(Narrative.class))
