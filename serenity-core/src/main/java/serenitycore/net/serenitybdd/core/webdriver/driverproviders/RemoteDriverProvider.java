...
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.BROWSERSTACK_URL;
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.SAUCELABS_URL;
