...
public class SmartAnnotations extends Annotations {
    ...
    private void assertValidAnnotations() {
        ...
        if(myDepFindBy != null && myFindBy != null) {
            throw new IllegalArgumentException(("Do not combine the serenity_bdd and thucydides namespace. The thucydides namespace is now deprecated, so please convert."));
        }
    ...
    /** @deprecated use serenity_bdd variation
     *
     */
    @Deprecated
