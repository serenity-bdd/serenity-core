...
import serenitycore.net.thucydides.core.steps.samples.FlatScenarioSteps;
import serenitycore.net.thucydides.core.steps.samples.NestedScenarioSteps;
import serenitycore.net.thucydides.core.steps.samples.StepsDerivedFromADifferentDomain;
import serenitymodel.net.serenitybdd.core.collect.NewList;
import serenitycore.net.thucydides.core.ListenerInWrongPackage;
...
public class WhenRecordingStepExecutionResults {
    ...
    public void the_listener_should_record_the_tested_story_instance_without_a_class() {
        ...
        StepEventBus.getEventBus().testSuiteStarted(serenitymodel.net.thucydides.core.model.Story.from(MyStory.class));
    ...
    public void the_listener_should_record_the_tested_story_instance_without_a_class_via_the_test() {
        ...
        StepEventBus.getEventBus().testSuiteStarted(MyStory.class);
        StepEventBus.getEventBus().testStarted("app_should_work", MyStory.class);
        StepEventBus.getEventBus().testStarted("app should work", serenitymodel.net.thucydides.core.model.Story
            .from(MyStory.class));
    ...
    public void the_listener_should_record_mulitple_tested_story_instances_without_a_class_via_the_tests() {
        ...
        StepEventBus.getEventBus().testStarted("app should still work", serenitymodel.net.thucydides.core.model.Story
            .from(MyStory.class));
        StepEventBus.getEventBus().testFinished(testOutcome);

        StepEventBus.getEventBus().testStarted("app should work", serenitymodel.net.thucydides.core.model.Story
            .from(AnotherStory.class));
        StepEventBus.getEventBus().testFinished(testOutcome);
    ...
    public void you_can_also_specify_the_story_class_directly() {
        ...
        TestOutcome outcome = stepListener.getTestOutcomes().get(0);
        serenitymodel.net.thucydides.core.model.Story story = outcome.getUserStory();
