...
public class ExecutedStepDescription implements Cloneable {
    ...
    public ExecutedStepDescription(final Class<? extends Object> stepsClass,
        final String name,
        final boolean isAGroup) {
    ...
    public ExecutedStepDescription(final String name) {
    ...
    public String getTitle() {
        try {
            ...
            return NameConverter.humanize(name);
        }
    }
