package serenitymodel.net.thucydides.core.steps;
...
public final class AnnotatedStepDescription {
    ...
    private static final List<String> VALID_STEP_ANNOTATIONS = NewList
...
//    }
    ...
    private Method findMethodCalled(final ExecutedStepDescription method, final Class<?> testClass) {
        return MethodFinder
            .inClass(testClass).getMethodNamed(withNoArguments(method.getName()), method.getArguments().size());
    }
    ...
    private String stepName() {
        ...
        return NameConverter.humanize(description.getName());
    }
