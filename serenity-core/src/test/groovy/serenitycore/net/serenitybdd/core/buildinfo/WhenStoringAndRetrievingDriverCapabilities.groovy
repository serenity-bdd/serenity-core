package serenitycore.net.serenitybdd.core.buildinfo

import serenitycore.net.serenitybdd.core.webdriver.driverproviders.CapabilitiesToPropertiesConverter
