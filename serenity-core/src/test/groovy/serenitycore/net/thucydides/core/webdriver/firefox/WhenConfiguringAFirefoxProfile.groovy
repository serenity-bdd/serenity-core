package serenitycore.net.thucydides.core.webdriver.firefox

import serenitycore.net.serenitybdd.core.webdriver.driverproviders.FirefoxDriverCapabilities
