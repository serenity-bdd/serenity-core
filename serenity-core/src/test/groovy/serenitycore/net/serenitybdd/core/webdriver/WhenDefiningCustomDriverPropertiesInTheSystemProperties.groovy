...
import serenitycore.net.serenitybdd.core.webdriver.driverproviders.AddEnvironmentSpecifiedDriverCapabilities
import serenitycore.net.serenitybdd.core.webdriver.driverproviders.CustomCapabilities
