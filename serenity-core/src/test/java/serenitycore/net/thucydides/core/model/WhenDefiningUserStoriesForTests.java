package serenitycore.net.thucydides.core.model;
...
public class WhenDefiningUserStoriesForTests {
    ...
    public void a_test_case_should_be_validating_a_user_story() {
        Class<?> userStoryClass = serenitymodel.net.thucydides.core.model.Story.testedInTestCase(WhenUserPurchasesNewWidgets.class);
    ...
    public void but_not_all_test_cases_have_a_user_story() {
        Class<?> userStoryClass = serenitymodel.net.thucydides.core.model.Story.testedInTestCase(WhenDoingSomethingElse.class);
    ...
    public void several_test_cases_can_test_the_same_user_story() {
        Class<?> userStoryClass = serenitymodel.net.thucydides.core.model.Story.testedInTestCase(WhenUserPurchasesNewWidgets.class);
        Class<?> userStoryClass2 = serenitymodel.net.thucydides.core.model.Story.testedInTestCase(WhenUserPurchasesLotsOfNewWidgets.class);
    ...
    public void a_user_story_is_identified_by_the_story_class() {
        serenitymodel.net.thucydides.core.model.Story story = serenitymodel.net.thucydides.core.model.Story
            .from(MyUserStories.PurchaseNewWidget.class);
    ...
    public void a_user_story_can_be_created_using_a_class_name_that_no_longer_exists() {
        serenitymodel.net.thucydides.core.model.Story story = serenitymodel.net.thucydides.core.model.Story
            .withId("net.thucydides.core.model.ThisClassNoLongerExists", "This class no longer exists");
    ...
    public void stories_with_the_same_story_class_are_identical() {
        serenitymodel.net.thucydides.core.model.Story story1 = serenitymodel.net.thucydides.core.model.Story
            .from(MyUserStories.PurchaseNewWidget.class);
        serenitymodel.net.thucydides.core.model.Story story2 = serenitymodel.net.thucydides.core.model.Story
            .from(MyUserStories.PurchaseNewWidget.class);
    ...
    public void stories_with_different_story_classes_are_not_identical() {
        serenitymodel.net.thucydides.core.model.Story story1 = serenitymodel.net.thucydides.core.model.Story
            .from(MyUserStories.DisplayWidgets.class);
        serenitymodel.net.thucydides.core.model.Story story2 = serenitymodel.net.thucydides.core.model.Story
            .from(MyUserStories.PurchaseNewWidget.class);
    ...
    public void stories_with_the_same_story_class_are_identical_even_if_the_class_is_no_longer_available() {
        serenitymodel.net.thucydides.core.model.Story story1 = serenitymodel.net.thucydides.core.model.Story
            .from(MyUserStories.PurchaseNewWidget.class);
        serenitymodel.net.thucydides.core.model.Story story2
          = serenitymodel.net.thucydides.core.model.Story
    ...
    public void a_story_can_be_defined_using_a_name_and_a_path() {
        serenitymodel.net.thucydides.core.model.Story story = serenitymodel.net.thucydides.core.model.Story
            .withIdAndPath("storyId","story name","a.b.c");
