package serenitymodel.net.thucydides.core.configuration;
...
import static serenitymodel.net.thucydides.core.configuration.SystemPropertiesConfiguration.PROJECT_BUILD_DIRECTORY;
