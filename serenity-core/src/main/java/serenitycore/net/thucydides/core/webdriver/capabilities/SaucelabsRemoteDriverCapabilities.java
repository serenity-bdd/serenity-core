package serenitycore.net.thucydides.core.webdriver.capabilities;
...
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.REMOTE_PLATFORM;
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.SAUCELABS_TEST_NAME;
