 ...
 */
public class OldPackageAnnotationBasedTagProvider extends AbstractRequirementsTagProvider implements RequirementsTagProvider, OverridableTagProvider {
    ...
    public OldPackageAnnotationBasedTagProvider() {
        this(Injectors.getInjector().getProvider(EnvironmentVariables.class).get() );
    }

    public OldPackageAnnotationBasedTagProvider(EnvironmentVariables vars) {
        super(vars);
