...
import serenitycore.net.serenitybdd.core.configurers.WebDriverConfigurer;
...
import serenitycore.net.serenitybdd.core.reports.ReportDataSaver;
import serenitycore.net.serenitybdd.core.reports.WithTitle;
import serenitycore.net.serenitybdd.core.sessions.TestSessionVariables;
...
public class Serenity {
   ...
   /**
    ...
    public static void done() {
        ...
        boolean restartBrowserIfNecessary = !RestartBrowserForEach.configuredIn(environmentVariables).restartBrowserForANew(
            RestartBrowserForEach.NEVER);
