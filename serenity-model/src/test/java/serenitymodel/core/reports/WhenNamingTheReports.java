...
import static serenitymodel.net.thucydides.core.model.ReportType.HTML;
import static serenitymodel.net.thucydides.core.model.ReportType.XML;
...
public class WhenNamingTheReports {
    ...
    public void the_report_filename_should_replace_spaces_with_underscores() {
        ...
        TestOutcome testOutcome = TestOutcome.forTestInStory("A simple test case", serenitymodel.net.thucydides.core.model.Story
