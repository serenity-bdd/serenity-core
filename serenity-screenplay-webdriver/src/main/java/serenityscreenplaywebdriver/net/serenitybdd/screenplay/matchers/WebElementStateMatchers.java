package serenityscreenplaywebdriver.net.serenitybdd.screenplay.matchers;

import serenitycore.net.serenitybdd.core.pages.WebElementState;
import serenityscreenplaywebdriver.net.serenitybdd.screenplay.matchers.statematchers.*;
