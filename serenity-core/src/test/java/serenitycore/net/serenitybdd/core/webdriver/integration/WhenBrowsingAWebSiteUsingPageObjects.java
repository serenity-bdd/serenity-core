package serenitycore.net.serenitybdd.core.webdriver.integration;

import io.github.bonigarcia.wdm.WebDriverManager;
import serenitycore.net.serenitybdd.core.pages.PageObject;
import serenitycore.net.serenitybdd.core.pages.PageUrls;
import serenitycore.net.serenitybdd.core.pages.WebElementFacade;
import serenitycore.net.serenitybdd.core.pages.WebElementFacadeImpl;
...
public class WhenBrowsingAWebSiteUsingPageObjects {
    ...
    public class IndexPage extends PageObject {
        ...
        @serenitycore.net.serenitybdd.core.annotations.findby.FindBy(id="firstname")
        public WebElement firstnameWithExtendedFindBy;

        @serenitycore.net.serenitybdd.core.annotations.findby.FindBy(css="#firstname")
        public WebElementFacade firstnameFacadeWithExtendedFindBy;

        @FindBy(name = "specialField")
        public WebElementFacade extra;

        @serenitycore.net.serenitybdd.core.annotations.findby.FindBy(name = "specialField")
        public WebElementFacade extraWithExtendedFindBy;

        @serenitycore.net.serenitybdd.core.annotations.findby.FindBy(ngModel = "angularField")
