...
public class ConsumerConsequence<T> extends BaseConsequence<T> {
    ...
    public ConsumerConsequence(Question<T> actual, Predicate<T> expected) {
        this(null, actual, expected);
    }

    public ConsumerConsequence(String subjectText, Question<T> actual, Predicate<T> expected) {
