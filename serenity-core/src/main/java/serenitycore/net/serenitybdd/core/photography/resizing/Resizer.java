package serenitycore.net.serenitybdd.core.photography.resizing;

import serenitymodel.net.serenitybdd.core.environment.ConfiguredEnvironment;
import serenitycore.net.serenitybdd.core.photography.PhotoFilter;
import serenitycore.net.serenitybdd.core.photography.ScreenshotNegative;
...
import static serenitymodel.net.thucydides.core.ThucydidesSystemProperty.THUCYDIDES_RESIZED_IMAGE_WIDTH;
