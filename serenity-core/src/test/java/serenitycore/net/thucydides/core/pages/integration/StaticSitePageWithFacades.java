...
public class StaticSitePageWithFacades extends PageObject {
        ...
        @FindBy(name = "firstname")
        protected serenitycore.net.thucydides.core.pages.WebElementFacade legacyFirstName;
        ...
        @FindBy(id = "clients")
        protected serenitycore.net.thucydides.core.pages.WebElementFacade legacyClients;
