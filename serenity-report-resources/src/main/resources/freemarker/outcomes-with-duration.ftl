                        ...
                        <td width="375px" valign="top">
                            <div class="test-count-summary">
                                <div>
                                    ...
                                    ${testOutcomes.totalTestScenarios} ${scenarioLabel}
                                    ...
                                    <#if testOutcomes.resultFilterName != 'SUCCESS'>
                                        <p class="report-info"><i class="bi bi-info-circle"></i> Note that results
                                            include
                                            data-driven scenarios containing ${testOutcomes.resultTypeLabel} ,
                                            which may also contain results other than ${testOutcomes.resultTypeLabel} .
                                        </p>
                                    </#if>
