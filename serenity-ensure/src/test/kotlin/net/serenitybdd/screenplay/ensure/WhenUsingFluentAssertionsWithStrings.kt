    ...
    inner class WeCanCheckFor {
        ...
        inner class Contains {
            ...
            fun `when the string does not contain the text`() {
                shouldFailWithMessage("""|Expecting a value that is containing: <[yellow]>
        ...
        inner class DoesNotContain {
            ...
            fun `when the text contains the string`() {
                shouldFailWithMessage("""|Expecting a value that is not containing: <[red]>
                                         |But got.................................: <"red green blue">"""
                        .trimMargin())
        ...
        inner class ContainsIgnoringCase {
            ...
            @Test
            fun `when the string does not contain the text`() {
                shouldFailWithMessage("""|Expecting a value that is containing (ignoring case): <[yellow]>
                                         |But got.............................................: <"red green blue">"""
                        .trimMargin())
        ...
        inner class UpperCase {
            ...
            fun `when the string is not in upper case`() {
                shouldFailWithMessage("""|Expecting a value that is in uppercase
                                         |But got: <"foo">"""
                        .trimMargin())
        ...
        inner class LowerCase {
            ...
            fun `when the string is not in lower case`() {
                shouldFailWithMessage("""|Expecting a value that is in lowercase
                                         |But got: <"FOO">"""
                        .trimMargin())
        ...
        inner class StartsWith {
            ...
            fun `when the string does not start with text`() {
                shouldFailWithMessage("""|Expecting a value that is starting with: <"yellow">
                                         |But got................................: <"red green blue">"""
                        .trimMargin())
        ...
        inner class EndsWith {
            ...
            fun `when the string does not ends with text`() {
                shouldFailWithMessage("""|Expecting a value that is ending with: <"yellow">
                                         |But got..............................: <"red green blue">"""
                        .trimMargin())
        ...
        inner class ContainsWhitespaces {
            ...
            fun `when the string has no whitespaces`() {
                shouldFailWithMessage("""|Expecting a value that is containing whitespaces
                                         |But got: <"FOO">"""
                        .trimMargin())
        ...
        inner class ContainsOnlyWhitespaces {
            ...
            @Test
            fun `when the string has no whitespaces`() {
                shouldFailWithMessage("""|Expecting a value that is containing only whitespaces
                                         |But got: <"FOO">"""
                        .trimMargin())
        ...
        inner class DoesNotContainAnyWhitespaces {
            ...
            @Test
            fun `when the string has no whitespaces`() {
                shouldFailWithMessage("""|Expecting a value that is without any whitespaces
                                         |But got: <"foo bar">"""
                        .trimMargin())
        ...
        inner class ContainsOnlyDigits {
            ...
            fun `when the string has no digits`() {
                shouldFailWithMessage("""|Expecting a value that is containing only digits
                                         |But got: <"FOO">"""
                        .trimMargin())
        ...
        inner class ContainsOnlyLetters {
            ...
            fun `when the string has no letters`() {
                shouldFailWithMessage("""|Expecting a value that is containing only letters
                                         |But got: <"123">"""
                        .trimMargin())
        ...
        inner class ContainsOnlyLettersOrDigits {
            ...
            @Test
            fun `when the string has no letters`() {
                shouldFailWithMessage("""|Expecting a value that is containing only letters or digits
                                         |But got: <"$$$">"""
                        .trimMargin())
        ...
        inner class HasSize {
            ...
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is of size: <3>
                                         |But got..........................: <"green">"""
                        .trimMargin())
        ...
        inner class HasSizeGreaterThan {
            ...
            @Test
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is of size greater than: <10>
                                         |But got.......................................: <"green">"""
                        .trimMargin())
        ...
        inner class HasSizeGreaterThanOrEqualTo {
            ...
            @Test
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is of size greater than or equal to: <10>
                                         |But got...................................................: <"green">"""
                        .trimMargin())
        ...
        inner class HasSizeLessThan {
            ...
            @Test
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is of size less than: <3>
                                         |But got....................................: <"green">"""
                        .trimMargin())
        ...
        inner class HasSizeLessThanOrEqualTo {
            ...
            @Test
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is of size less than or equal to: <3>
                                         |But got................................................: <"green">"""
                        .trimMargin())
        ...
        inner class HasSizeBetween {
            ...
            @Test
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is of size of between <1> and <4>
                                         |But got: <"green">"""
                        .trimMargin())
        ...
        inner class HasSameSizeAs {
            ...
            @Test
            fun `when the string does not have the expected size`() {
                shouldFailWithMessage("""|Expecting a value that is the same size as: <"red">
                                         |But got...................................: <"green">"""
                        .trimMargin())
        ...
        inner class HasLineCount {
            ...
            fun `when the string does not have the expected line count`() {
                shouldFailWithMessage("""|Expecting a value that is with a line count of: <3>
                                         |But got.......................................: <"green">"""
                        .trimMargin())
