...
Resolved issue where the screenshot viewer in reports would always open at the first screenshot (index 0) regardless of which screenshot thumbnail was clicked.

**Issue:** https://github.com/serenity-bdd/serenity-core/issues/3685

### Fixed report sorting by test outcome (#3700)

Fixed an issue where sorting test results by outcome (passed, failed, etc.) was not working correctly.

**Issue:** https://github.com/serenity-bdd/serenity-core/issues/3700
...
**Resolution:** Migrate to JUnit 5 (see [migration guide](../../serenity-cucumber/MIGRATION_5.0.0.md)). JUnit 4 support will be removed in Serenity 6.0.0.
...
A: Only if you're using JUnit 4 with Cucumber. You need to update the plugin path in your test suite configuration.

**Q: How long do I have to migrate from JUnit 4?**
A: You have the entire 5.x release cycle (anywhere between 3 and 12 months) before JUnit 4 support is removed in 6.0.0.
