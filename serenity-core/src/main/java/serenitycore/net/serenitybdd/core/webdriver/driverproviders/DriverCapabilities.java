...
import static serenitycore.net.thucydides.core.webdriver.SupportedWebDriver.*;
import static serenitycore.net.thucydides.core.webdriver.WebDriverFactory.REMOTE_DRIVER;
