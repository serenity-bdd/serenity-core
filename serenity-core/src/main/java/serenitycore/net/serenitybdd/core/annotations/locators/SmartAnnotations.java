package serenitycore.net.serenitybdd.core.annotations.locators;

import serenitycore.net.serenitybdd.core.annotations.findby.By;
...
//                }
    ...
    protected void assertValidAnnotations() {
        ...
        serenitycore.net.thucydides.core.annotations.findby.FindBy myDepFindBy = field.getAnnotation(
            serenitycore.net.thucydides.core.annotations.findby.FindBy.class);
...
//        }
     ...
     */
    @Deprecated
    protected org.openqa.selenium.By buildByFromFindBy(
        serenitycore.net.thucydides.core.annotations.findby.FindBy myDepFindBy) {
     ...
     */
    @Deprecated
    protected org.openqa.selenium.By buildByFromLongFindBy(
        serenitycore.net.thucydides.core.annotations.findby.FindBy myDepFindBy) {
     ...
     */
    @Deprecated
    protected org.openqa.selenium.By buildByFromShortFindBy(
        serenitycore.net.thucydides.core.annotations.findby.FindBy myDepFindBy) {
    ...
    private void assertValidFindBy(
        serenitycore.net.thucydides.core.annotations.findby.FindBy findDepBy) {
