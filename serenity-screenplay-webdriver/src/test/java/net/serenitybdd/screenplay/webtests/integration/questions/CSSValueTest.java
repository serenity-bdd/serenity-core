...
public class CSSValueTest extends ScreenplayInteractionTestBase {
    ...
    public void checkForAnAttributeOfAFieldUsingATarget() {
        assertThat(dina.asksFor(CSSValue.of(FIRST_NAME_FIELD).named("placeholder"))).isEqualTo("First Name");
    }
