...
**Screenplay + `@UsePlaywright` Integration and Reporting Improvements**

This release adds `BrowseTheWebWithPlaywright.withPage(Page)` for using Screenplay actors with `@UsePlaywright`-managed browsers, and fixes a confusing duration label in the HTML report.
