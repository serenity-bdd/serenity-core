...
class WhenStoringStoriesAsJSON extends Specification {
    ...
    def "should generate an JSON report for a story"() {
        given:
        def story = new Story(AUserStory.class)
...
"""
        ...
        then:
        story == new Story(AUserStory.class)
    }


    def "should generate an JSON report for a story with a feature"() {
        given:
        def story = new Story(AFeature.AUserStoryInAFeature.class)
...
"""
        ...
        then:
        story == new Story(AFeature.AUserStoryInAFeature.class)
    }
