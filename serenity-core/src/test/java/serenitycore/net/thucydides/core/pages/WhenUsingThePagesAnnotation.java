...
import serenitycore.net.serenitybdd.core.pages.PagesAnnotatedField;
import serenitycore.net.thucydides.core.annotations.ManagedPages;
import serenitymodel.net.thucydides.core.reflection.FieldSetter;
import serenitycore.net.thucydides.core.steps.InvalidManagedPagesFieldException;
