package serenitycore.net.serenitybdd.core.webdriver.configuration
...
import static serenitycore.net.serenitybdd.core.webdriver.configuration.RestartBrowserForEach.*
