package serenitycore.net.thucydides.core.webdriver.integration;
...
public class WhenBrowsingAWebSiteUsingPageObjects {
    ...
    public class IndexPage extends PageObject {
        ...
        @serenitycore.net.thucydides.core.annotations.findby.FindBy(id="firstname")
        public WebElement firstnameWithExtendedFindBy;

        @serenitycore.net.thucydides.core.annotations.findby.FindBy(css="#firstname")
        public WebElementFacade firstnameFacadeWithExtendedFindBy;

        @FindBy(name = "specialField")
        public WebElementFacade extra;

        @serenitycore.net.thucydides.core.annotations.findby.FindBy(name = "specialField")
        public WebElementFacade extraWithExtendedFindBy;

        @serenitycore.net.thucydides.core.annotations.findby.FindBy(ngModel = "angularField")
    ...
    public void should_print_web_element_facades_in_a_readable_form() {
        ...
        assertThat(indexPage.checkbox()
                .toString(), is("IndexPage.checkbox"));
    }
