package serenitycore.net.thucydides.core.pages.jquery;
...
import serenitycore.net.thucydides.core.webdriver.javascript.JavascriptSupport;
...
public class JQueryEnabledPage {
    ...
    public boolean isJQueryAvailable() {
        ...
        if (jqueryIntegrationEnabled && JavascriptSupport.javascriptIsSupportedIn(driver)) {
            try {
    ...
    protected void executeScriptFrom(String scriptSource) {
        if (JavascriptSupport.javascriptIsSupportedIn(driver)) {
