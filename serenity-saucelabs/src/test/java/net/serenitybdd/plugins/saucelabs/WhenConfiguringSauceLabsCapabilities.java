...
//
//    @Test
//    public void platformAndBrowserVersionsAreDefinedAtTheTopLevel() {
//        environmentVariables.setProperty("webdriver.capabilities.platformName", "macOS 11");
//        environmentVariables.setProperty("webdriver.capabilities.browserVersion", "14");
//        environmentVariables.setProperty("webdriver.capabilities.browserName", "Safari");
//
//        SaucelabsRemoteDriverCapabilities capabilities = new SaucelabsRemoteDriverCapabilities(environmentVariables);
//        MutableCapabilities saucelabsCapabilities = capabilities.getCapabilities(new MutableCapabilities());
//
