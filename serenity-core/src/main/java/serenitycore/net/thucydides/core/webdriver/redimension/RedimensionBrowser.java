package serenitycore.net.thucydides.core.webdriver.redimension;
...
import static serenitycore.net.thucydides.core.webdriver.redimension.RedimensionStrategy.*;
